...
| 3. Import the legacy OrderList data into preview | 🟨 in progress | 2026-08-12 | Source finalized: owner accepted `C:\Users\ahazan2\Downloads\OrderList.xlsx` (SHA-256 `68c9b03a0ec183e08b3a8f2344397e1bc4f61e73457849e7bf8c0cf7fb2409fe`, issue #727). Re-profile complete through the corrected importer; the column-AR Style#-mirror root-cause fix (`sub_sku_mirrors_style`) and 89 focused tests are ready on branch `codex/issue-727-claude-821` (working tree, not yet merged). Eight conditional baselines re-derived and armed against the new SHA. **NOT yet done:** preview dry-run, preview write to `rjyboqwcdzcocqgmsyel`, `--verify-idempotency`, and the committed reconciliation report. No database writes have been made. |
