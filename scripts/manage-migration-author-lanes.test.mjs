...
function expansionIo(overrides={}){
  const io=memoryIo(),issue={number:1063,state:'open',body:claimBody({version:'20260816063532',objects:['index plm.item_upper_trim_item_number_idx'],owner:'session',branch:'codex/index',worktree:'C:/index',expiresAt:new Date('2026-08-17T00:00:00Z')})}
  ...
  io.getPr=()=>({state:'open',head:{sha:'head',ref:'codex/index'}});io.openClaims=()=>[structuredClone(issue)]
...
const expansionOptions={claim:1063,pr:1065,owner:'session',headSha:'head',branch:'codex/index',worktree:'C:/index',requestId:'expand',mutexAttempts:1}
