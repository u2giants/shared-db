...
|---|---|
| PopDAM / Master Data / PopSG | Customers/organizations; Licensing Master Data; merchandise/product taxonomy; product/item identity; digital-asset integrity; digital-asset classification/tags; product workflow when linking assets to products, samples, or orders |
| PopCRM | Shared objects and customer identity; Licensing Master Data when opportunities or approvals reference Licensors or Properties; product-development workflow when CRM activity creates or follows product work |
...
| DesignFlow Item Master | Shared objects; Licensing Master Data; Merchandise groups and product taxonomy; RFQ pricing for Item Master endpoints that supply pricing inputs; product-development workflow for item lifecycle behavior |
...
| DB Data Admin | Shared objects; Licensing Master Data; Merchandise groups and product taxonomy; ERP meaning when reviewing source-fed data |
...
| MG01-MG14, `mgCategory`, Product Type, subtype, size, merchandise-group code, or division meaning | [`merchandise-and-product-taxonomy.md`](merchandise-and-product-taxonomy.md) |
