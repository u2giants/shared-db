...
**Fresh implementation starts at Step 4** (Steps 0-2 landed; Step 3 landed only in the partial scope certified in its closeout — see the STATUS table). Use a fresh session at the boundaries after Steps 2, 4, 6, and 7; before starting a new phase, re-read this STATUS table and all remaining phases for drift.
---
