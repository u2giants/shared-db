...
begin
  ...
  select public.create_dam_order(
    jsonb_build_object(
      ...
      -- writable through this RPC in 20260830111545 (issue #1772). Passing one here now
    ...
    jsonb_build_array(
      -- line_number is DERIVED from position since 20260830111545; these four lines
  ...
  -- 20260830111545 made it non-writable; void_reason is the writable field now, and the
