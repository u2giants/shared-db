...
--   20260830141421_popdam_orderlist_input_only_write_contract.sql (issue #1772), which
...
begin
  ...
  select public.create_dam_order(
    jsonb_build_object(
      ...
      -- writable through this RPC in 20260830141421 (issue #1772). Passing one here now
    ...
    jsonb_build_array(
      -- line_number is DERIVED from position since 20260830141421; these four lines
  ...
  -- 20260830141421 made it non-writable; void_reason is the writable field now, and the
