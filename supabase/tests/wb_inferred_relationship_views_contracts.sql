...
values ('10490000-0000-4000-8000-000000000001',0,'wb_asset_normalized','complete',date '2099-04-09','synthetic',repeat('a',64),0,'synthetic','https://example.invalid',now());
