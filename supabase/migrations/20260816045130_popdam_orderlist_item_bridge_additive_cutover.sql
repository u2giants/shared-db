...
BEGIN
  ...
  upserted AS (
    ...
    ON CONFLICT (style_tracker_row_id) DO UPDATE SET
      ...
      erp_item_id = coalesce(EXCLUDED.erp_item_id, plm.style_tracker_item_bridge.erp_item_id),
      ...
      plm_item_id = coalesce(EXCLUDED.plm_item_id, plm.style_tracker_item_bridge.plm_item_id),
