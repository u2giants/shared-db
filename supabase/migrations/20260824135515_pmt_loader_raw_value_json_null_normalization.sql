-- Issue #1418 -- Repair the Paramount JSON-null metadata load.
--
...
-- (20260814223552, the third rewrite), not a merge of an older one.
...
'accepts only SQL NULL or a safe JSON object. The constraint itself is unchanged.';
