-- Issue #2706: derive DCP display authority from the stable terminal identity before pagination.
-- derived-from: 20260910155753, 20260910123636
-- Function definition captured read-only from production after #2579; all other source groups retained.
