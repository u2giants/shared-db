-- Phase 2A — ColdLion licensor/property MIRROR-ONLY importer (no canonical writes).
-- Migration: 20260724060000_coldlion_licensor_property_phase2a_mirror_importer.sql
-- Plan: fix_coldlion_licensor_property_cutover.md (Phase 2 / §15.1 Phase 2A).
--
-- What this does
-- --------------
-- Adds the guarded, mirror-only database importer for the Phase 1 licensor/property
-- mirror schema (20260724030000). It is the DB half of the operational runner
