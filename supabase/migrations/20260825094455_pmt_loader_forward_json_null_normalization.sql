...
-- only the trio would leave the older 20260814223552 body last and silently restore the defect.
--
...
--
-- This is a full re-derivation of the CURRENT function body on main
-- (20260824135515), not a copy or merge of any older rewrite.
