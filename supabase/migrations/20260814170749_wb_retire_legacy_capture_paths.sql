-- Issues #958 and #946: retire the empty first-generation Warner mirrors and keep
-- only the normalized capture contract. Historical capture headers remain readable.
