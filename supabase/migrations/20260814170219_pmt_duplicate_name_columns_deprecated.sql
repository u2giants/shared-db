...
-- stops sending the two name fields, so a pre-20260814170219 function body would read
...
comment on column plm.pmt_authorized_title_property.paramount_property_name is
  'DEPRECATED 2026-08-14 (20260814170219) -- duplicate of plm.pmt_property.property_name. '
  ...
  'Nullable and unwritten since 20260814170219 -- the client loader and '
...
comment on column plm.pmt_property_capture_log.property_name is
  ...
  'property_source_id) instead. Nullable and unwritten since 20260814170219 -- the client '
...
'As of 20260814170219 it no longer writes the duplicated property-name copies on '
