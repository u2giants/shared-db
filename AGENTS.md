...
- **Paramount capture validation after the 2026-08-24 preview rehearsal:** [`fix_Paramount_capture_against_preview.md`](fix_Paramount_capture_against_preview.md). Read its STATUS table first. The three required migrations are already on preview; the remaining job is a licensed source-data capture against preview. Production is explicitly forbidden until separately authorized.
