...
export function buildPayloads(cap) {
  ...
  return {
    ...
    // carries for the same (capture_id, property_source_id). Migration 20260814170219
    ...
    // plm.pmt_property for the name. Migration 20260814170219 deprecated the column.
