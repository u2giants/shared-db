...
export const MASTER_SPECS = Object.freeze({
  ...
  merch_group_detail: {
    endpoint: "/merchGroupDetails", key: ["company_code","division_code","mg_type_code","mg_code"], paged: false, active: true,
    fields: [f("companyCode","company_code"),f("divisionCode","division_code"),f("mgTypeCode","mg_type_code"),f("mgCode","mg_code"),...common,f("mgDesc","mg_desc"),f("itemNoCode","item_no_code"),f("mgCategory","mg_category"),f("mgCode2","mg_code2"),f("active","active")],
    ignored: ["createdUser","modUser"],
  },
});
